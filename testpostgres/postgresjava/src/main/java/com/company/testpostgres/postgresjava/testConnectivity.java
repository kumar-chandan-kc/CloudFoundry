...
/**
 * Servlet implementation class testConnectivity
 */
@WebServlet(description = "test connection to on premise systems", urlPatterns = { "/testConnectivity" })
...
//			urlConnection.setRequestProperty("Authorization", "Basic QVJPUkFISTpISU1CSEFWNHNodWJo");
