...
/**
 * Servlet implementation class testConnectivity2
 */
@WebServlet(description = "direct connection to abap systems(hardcoded)", urlPatterns = { "/testConnectivity2" })
public class testConnectivity2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public testConnectivity2() {
        super();
...
//			s = request.getParameter("test");
			...
			if(s.equals(""))
			{ url = new URL(
					"http://sapjira.wdf.sap.corp:44300/rest/api/2/issue/5041087");}
			else
			{
				 url = new URL(s);
			}
...
//			String authtoken = request.getParameter("basic");
			urlConnection.setRequestProperty("Authorization", "Basic STMzMTY3NzpUYW5kaXgxMDA=");
